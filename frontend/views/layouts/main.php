...
<div class="wrap">
    ...
    if (Yii::$app->user->isGuest) {
        ...
        $menuItems[] = ['label' => 'Login', 'url' => ['/site/login']];
                ...
                $menuItems[] = ['label' => 'New Transaction', 'url' => ['/transaction/create']];
                $menuItems[] = ['label' => 'Daily Transactions', 'url' => ['/transaction/dailyindex']];
            //    $menuItems[] = ['label' => 'Transactions', 'url' => ['/transaction/index']];
    //    $menuItems[] = ['label' => 'Work', 'url' => ['/work/index']];
